# Artificial Neural Network Classifier in TensorFlow (CPU) with LIME explanations
## Project Description
...
- A **Artificial Neural Network (ANN)** classifier built using **TensorFlow**. The model runs on CPU.
